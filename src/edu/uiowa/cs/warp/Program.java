...
public class Program implements SystemAttributes {
  ...
  /**
   * 
   * @return (WorkLoad) returns the workload instance variable of this class. 
   * Workload is a class that builds the nodes and flows for the workload described in the workload description file.
   */
  ...
  /**
   * Returns the instructions for each node to execute for each time slot. 
   * @return The schedule for the flow.
   */
  ...
  /**
   * Creates a mapping from the alphabetically ordered nodes to each of their indexes. 
   * @return A Hashmap of node names and indexes.
   */
